...
app.layout = html.Div(
    [
        html.H1("Car Price Data App by Miai.vn",
        ...
        html.Div(
            [
                ...
                dcc.Dropdown(
                    ...
                    # Gia tri chon mac dinh luc dau
                    value=[car_brand_list[0]['value']]
                ),
                ...
                html.Div(
                    [
                        html.Span(
                            [
                                html.Span('Từ năm:', style={
                                          "textAlign": "center"}),
                                dcc.Input(id='from_year', value='1900',
                        ...
                        html.Span(
                            [
                                html.Span('Đến năm:', style={
                                          "textAlign": "center"}),
                                dcc.Input(id='to_year', value='2023',
                                          type='number', debounce=True)
                            ]
                        )
                    ], style={"textAlign": "center"}
...
@app.callback(
    ...
    Input("car_brand_dropdown", "value"),
...
def update_charts(car_brand_dropdown, car_type_dropdown, from_year, to_year):
    f_df = car_df[car_df.car_year != '<1900']
